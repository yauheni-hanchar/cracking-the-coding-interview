...
public class Task2_5 {
    ...
    private static SinglyLinkedList sumReversedLists(SinglyLinkedList.Node node1, SinglyLinkedList.Node node2) {
    ...
    public static SinglyLinkedList sumLists(SinglyLinkedList.Node node1, SinglyLinkedList.Node node2) {
        var result = new SinglyLinkedList();
        var current1 = node1;
        var current2 = node2;
